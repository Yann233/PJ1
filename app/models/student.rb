class Student < ActiveRecord::Base
  ...
  def enroll  #CREATE
   ...
   #binding.pry
    ...
    #Record.create(course_id: enroll_course_id.to_i, student_id: self.id, course_name: self.record.courses.name, grade: "Waiting", semester: "Spring2020")
    #Record.create(course_id: enroll_course_id.to_i, student_id: self.id, course_name: record.course.name, grade: "Waiting", semester: "Spring2020")
